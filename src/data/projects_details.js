export const PROJECTS = {
    es: [
      ...
      },
      {
        ...
        fecha: 'junio 2025', 
        state: 'completado',
        image: '/cardsImg/meloJewelry/melo-card.webp', 
        image2: '/cardsImg/meloJewelry/melo-logo.svg',
        imageD: '/cardsImg/meloJewelry/melo-detail.webp', 
        collaborate: false,
        title: 'Joyería Melo',
        description: 'Landing page completamente responsiva para joyería desarrollada con Astro y componentes React.',
        descriptionExtend: 'Sitio web corporativo para la joyería Melo que presenta una experiencia visual elegante y moderna. La landing page incluye catálogo de productos, información de la empresa, datos de contacto y una galería interactiva que destaca las piezas de joyería. El diseño responsivo garantiza una experiencia óptima en todos los dispositivos, desde móviles hasta escritorio. La implementación combina la velocidad de Astro con la interactividad de React para crear una interfaz fluida y atractiva.',
        rol: 'Como diseñadora y desarrolladora frontend, fui responsable del diseño completo de la interfaz de usuario, la arquitectura del sitio, la implementación del código, la optimización para dispositivos móviles y la integración de componentes interactivos.',
    ...
    en: [
      ...
      },
      {
        ...
        fecha: 'June 2025', 
        state: 'completed',
        image: '/cardsImg/melo/melo-landing.webp',
        image2: '/cardsImg/melo/melo-logo.svg',
        imageD: '/cardsImg/melo/melo-desktop.webp',
        collaborate: false,
        title: 'Melo Jewelry',
        description: 'Fully responsive landing page for jewelry store developed with Astro and React components.',
        descriptionExtend: 'Corporate website for Melo jewelry featuring an elegant and modern visual experience. The landing page includes product catalog, company information, contact details, and an interactive gallery showcasing jewelry pieces. The responsive design ensures optimal experience across all devices, from mobile to desktop. The implementation combines Astro\'s speed with React\'s interactivity to create a smooth and attractive interface.',
        rol: 'As a designer and frontend developer, I was responsible for the complete UI design, site architecture, code implementation, mobile optimization, and integration of interactive components.',
        tecnologias: ['Astro', 'React', 'TypeScript', 'JavaScript', 'HTML', 'CSS', 'Git', 'GitHub', 'Vercel'],
        viewMore: 'View more',
        github: 'https://github.com/Yanina-Unrein/jewellery_page', 
